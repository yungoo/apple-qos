...
public final class URL implements Serializable {
	...
	public URL(String protocol, String host, int port) {
	    this(protocol, host, port, (Map<String, String>) null);
	}
	
	/*public URL(String protocol, String host, int port, int xport, String[] pairs) { 
		// 变长参数...与下面的path参数冲突，改为数组
        this(protocol, host, port, CollectionUtils.toStringMap(pairs));
    }*/
	...
	public URL clearParameters() {
        return new URL(protocol, host, port, new HashMap<String, String>());
    }
    ...
    public String getServiceInterface() {
        return getParameter(Constants.KEY_INTERFACE);
    }

    public URL setServiceInterface(String service) {
        return addParameter(Constants.KEY_INTERFACE, service);
    }
