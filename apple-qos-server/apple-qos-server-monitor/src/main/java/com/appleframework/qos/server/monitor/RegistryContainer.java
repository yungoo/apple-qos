...
public class RegistryContainer implements Container {
    ...
    public Set<String> getProviderApplicationByServices(String service) {
    	Set<String> set = providerServiceApplications.get(service);
        return set;
    }
    
    public String getProviderApplicationByService(String service) {
    	Set<String> set = providerServiceApplications.get(service);
    	if(!set.isEmpty()) {
    ...
    public Set<String> getConsumerApplicationByServices(String service) {
    	Set<String> set = consumerServiceApplications.get(service);
        return set;
    }
    
    public String getConsumerApplicationByService(String service) {
    	Set<String> set = consumerServiceApplications.get(service);
    	if(!set.isEmpty()) {
    		return (String)set.toArray()[0];
    	}
    ...
    public void start() {
    	...
    	String url = PropertyConfigurer.getString(REGISTRY_ADDRESS);
