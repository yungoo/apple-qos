 ...
 */
@Controller
@RequestMapping(value = "/day_stat_code/")
public class DayStatCodeController {
    ...
    public ModelAndView list(String startDate,
        ...
        Pagination apps = dayStatCodeService.findPageByAppAndDay(page,
                startDateValue,
                endDateValue,
                consumerAppName,
                providerAppName);
        ...
        return new ModelAndView("day_stat_code/list", model);
    }
