...
public class PaginationInterceptor2 implements Interceptor, Serializable {
    /** serial Version */
    ...
    /** logging */
    private static final Log log = LogFactory.getLog(PaginationInterceptor2.class);
    ...
    private void processIntercept2(final Object[] queryArgs) {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        processIntercept2(invocation.getArgs());
    ...
    public void setDbms(String dbmsRep) {
        DBMS dbms;
        Preconditions.checkArgument(!StringHelper.isEmpty(dbmsRep), "dialect property is not found!");
        dbms = DBMS.valueOf(dbmsRep.toUpperCase());
        Preconditions.checkNotNull(dbms, "plugin not super on this database.");

        _dialect = DialectClient.getDbmsDialect(dbms);
    }

    public void setSqlRegex(String regex) {
