...
<script type="text/javascript">
	$().ready( function() {
		$("#listTable .btn_view").bind("click", function(){
			...
			art.dialog.open('${webRoot}/app_info/view?id=' + id, {
				id: 'viewFrame',
				title: title,
				close: function () {}
			}, false);
...
<div class="con_right_main">
    ...
    <table id="listTable" class="table_list list">
        ...
        <tr class="even">
			...
			<td>
				<a class="" href="${webRoot}/min_stat/list?consumerAppName=${(info.consumerAppName)!}&providerAppName=${(info.providerAppName)!}&statDate=${info.statDate?string('yyyy-MM-dd')}" title="明细">明细</a>|
				<a class="" href="${webRoot}/day_stat_code/list?consumerAppName=${(info.consumerAppName)!}&providerAppName=${(info.providerAppName)!}&startDate=${info.statDate?string('yyyy-MM-dd')}&endDate=${info.statDate?string('yyyy-MM-dd')}" title="返回码">返回码</a>|
				<a class="" href="${webRoot}/day_stat_node/list?consumerAppName=${(info.consumerAppName)!}&providerAppName=${(info.providerAppName)!}&startDate=${info.statDate?string('yyyy-MM-dd')}&endDate=${info.statDate?string('yyyy-MM-dd')}" title="节点">节点</a>|
			</td>
        </tr>
        </#list>
